...
public class QuoteOpportunitiesUnableServiceImpl extends ServiceImpl<QuoteOpportunitiesUnableMapper, QuoteOpportunitiesUnable> implements IQuoteOpportunitiesUnableService
{
    ...
    @Override
    public QuoteOpportunitiesUnableVO getByQuoteId(Long quoteId) {
        QuoteOpportunitiesUnable result = quoteOpportunitiesUnableMapper.selectOne(Wrappers.<QuoteOpportunitiesUnable>lambdaQuery()
                .eq(QuoteOpportunitiesUnable::getOpportunitiesId,quoteId)
