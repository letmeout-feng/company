...
@NoArgsConstructor
@Builder
@Schema(name = "ManageCost",description = "管理系统-成本设置对象")
...
public class ManageCost extends BaseEntity
{
    ...
    @Schema(description = "类型:[销售支持:SALES_SUPPORT,产品:PRODUCT,软件开发:SOFTWARE_DEVELOPMENT,采购-自研硬件:SELF_DEVELOPED,采购-外采硬件:EXTERNAL_PROCUREMENT,实施:IMPLEMENT,其他:OTHER]")
