                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <a-input-number :style="{ border: quotesPresaleInfo.xxAdditionalQuote !== null ? '2px solid #d9d9d9' : '2px solid rgb(235, 158, 158)' }" :step="1"
                                            :controls="false" placeholder="请输入" :disabled="props.isQuoteDetail"
