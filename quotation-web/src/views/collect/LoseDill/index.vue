<template>
    <div>
    <a-card title="丢单汇总" :headStyle="{ 'height': '66px' }">
        <template #extra>
            <div style="display: flex; justify-content: flex-start; align-items: center; text-align: center;">
                <div style="display: flex; align-items: center;gap: 8px;">
                    ...
                    <a-button type="primary" size="middle" :disabled="pagination.total < 1"
                        @click="exportData">导出</a-button>
                </div>
            </div>
        </template>
        <a-table :columns="visibleColumns" :data-source="data" :pagination="pagination" row-key="key"
            :loading="loading" :row-selection="rowSelection" @change="handleTableChange">
